...
#SBATCH --time=0-15:00
#SBATCH -o /home/pjohri/LOGFILES/varArguello_%A_rep%a.out
#SBATCH -e /home/pjohri/LOGFILES/varArguello_%A_rep%a.err
...
folder="Arguello_DFE_var_rec_droso"
...
then
    ...
    /mnt/storage/software/slim.3.1/build/slim -d d_seed=${repID} -d "d_repID='${repID}'" -d "d_folder='/home/pjohri/PlosgenDroso/simulations/${folder}'" Arguello_DFE_var_rec_droso_scaled100.slim
fi
