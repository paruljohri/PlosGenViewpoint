...
#python simulate_msprime_Arguello_var_rec.py -outFolder /scratch/pjohri1/PlosgenDroso/simulations/Arguello_var_rec -repNum repID
import sys
import os
import msprime
import math
...
#defining the recombination rate map:
#l_rates = []
#f_rec = open("/home/pjohri1/PlosgenDroso/Dmel_rec_rates/100kb_1000replicates/rep" + str(repID) + ".rrc", 'r')
#for line in f_rec:
#    line1 = line.strip('\n')
#    l_rates.append((float(line1)/2.0)*rec_rate_mean)
#f_rec.close()
#l_rates.append(0.0)
#l_positions = [0, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000]
#recomb_map = msprime.RecombinationMap(l_positions, l_rates)
...
def Arguello_INZ():
    ...
    population_configurations = [
        ...
        msprime.PopulationConfiguration(sample_size=num_indv, initial_size=Ncur_ith, growth_rate=r_ith)
    ]
    #migration matrix
    migration_matrix = [
