...
while [ $repID -lt 1001 ];
do
    python simulate_msprime_Duchen_const_rec.py -outFolder /scratch/pjohri1/PlosgenDroso/simulations/${folder} -repNum ${repID} -recType low
    repID=$(( ${repID} + 1 ))
done
