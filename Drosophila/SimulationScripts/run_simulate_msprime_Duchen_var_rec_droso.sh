...
#SBATCH --time=0-15:00
#SBATCH -o /home/pjohri1/LOGFILES/Duchen%j.out
#SBATCH -e /home/pjohri1/LOGFILES/Duchen%j.err
...
while [ $repID -lt 1001 ];
do
    python simulate_msprime_Duchen_var_rec.py -outFolder /scratch/pjohri1/PlosgenDroso/simulations/${folder} -repNum ${repID} -recMap droso
    repID=$(( ${repID} + 1 ))
done
